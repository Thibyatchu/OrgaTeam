...
class DashboardController extends AbstractDashboardController
{
    ...
    {
        return parent::index();$routeBuilder = $this->container->get(AdminUrlGenerator::class);
    ...
    public function configureMenuItems(): iterable
    {
        ...
        yield MenuItem::linkToCrud('TypeEvenement', 'fas fa-comments', TypeEvenement::class);
    }
}
